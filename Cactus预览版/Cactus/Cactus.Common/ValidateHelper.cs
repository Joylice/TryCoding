...
namespace Cactus.Common
{
    public class ValidateHelper
    {
        ...
        {
            return Regex.IsMatch(strIn, @"^[A-Za-z0-9_\-\u4e00-\u9fa5]+$");
        }
        ...
        {
            return Regex.IsMatch(strIn, @"^0?(13|14|15|18)[0-9]{9}/$");
        }
        ...
        public static string SqlFilter(string sInput)
        {
            ...
            if (Regex.Match(sInputLower, Regex.Escape(pattern), RegexOptions.Compiled | RegexOptions.IgnoreCase).Success)
            {
                return null;
            }
