...
data-ajax-type//json html
//new
data-ajax-before//ajax之前执行，可以用于检测参数和修改参数
...
(function ($) {
    ...
    function asyncRequest(element, options) {
        ...
        //new
        var fn_before = element.getAttribute("data-ajax-before");
        if (fn_before != null && fn_before!="") {
            fn_before = window[fn_before];
        }
        //console.log(typeof (fn_before))
        if (typeof (fn_before) === "function") {
            //console.log('data-ajax-before：true')
            if (!fn_before(element)) {
                return;
            }
        }
        ...
        $.extend(options, {
            ...
            dataType: element.getAttribute("data-ajax-type") || "html",
            ...
            success: function (data, status, xhr) {
                ...
                //console.log(data.msg + '|' + status.msg + '|' + xhr.msg)
