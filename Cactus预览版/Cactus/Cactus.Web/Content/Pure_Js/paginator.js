(function ($) {
    ...
    function bindPaginator(jq, o_state) {
        ...
        if (o_state.count == 1) {
            ...
            li_html += txt_temp.replace('{0}', countStr);
            console.log('li_html 1:' + li_html);
        } else {
            ...
            console.log('o_state.spacerNum:' + o_state.spacerNum);
            console.log('o_state.count:' + o_state.count);
            console.log('o_state.inPage:' + o_state.inPage);
